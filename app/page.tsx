...
export default function Home() {
  return (
    <div className="space-y-6">
      ...
      <p className="text-xl">Manage your courses, swap sections, and chat with your peers all in one place.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link href="/login" className="bg-gray-500 text-white p-4 rounded-lg text-center hover:bg-gray-600 transition-colors">
          Login / Sign Up
        </Link>
      </div>
    </div>
